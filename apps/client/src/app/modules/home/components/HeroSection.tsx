      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-[-0.04em] text-foreground mb-6 leading-[1.05]">
            Software Engineer
            <br />
            <span className="glow-text">& créateur de produits.</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-xl mb-10 leading-relaxed">
            Je conçois et développe des applications web performantes avec une obsession pour l'expérience utilisateur
            et le code propre.
          </p>
